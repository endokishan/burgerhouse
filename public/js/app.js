...
function updateStatus(Uorder) {
  ...
  statuses.forEach(function (status) {
    ...
    if (getData === Uorder.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_2___default()(Uorder.updatedAt).format('hh:mm A');
...
socket.on('orderUpdated', function (data) {
  ...
  new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
    ...
    theme: 'metroui',
    timeout: 1500,
    text: "Your Order ".concat(data.status)
  }).show();
});

/***/ }),

/***/ "./resources/js/postOrder.js":
/*!***********************************!*\
  !*** ./resources/js/postOrder.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function postOrder(formObject) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/orders', formObject).then(function (res) {
    ...
    }).show(); // resirect to customer order page
...
/* harmony import */ var _postOrder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./postOrder */ "./resources/js/postOrder.js");
        ...
        switch (_context.prev = _context.next) {
          case 0:
            mountWidget = function _mountWidget() {
              var elements = stripe.elements(); // Card Style
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51IFJekBzBgRoYoj8CFjxIsJ9Q6T3uuDEQl8xFfj4Pv3maV4wYneSq3zuMAe79DDSmkk0wPGCnkaV2TO0MYvL8oRm00p5ckmd0q');
          ...
          case 8:
            ...
            if (paymentForm) {
              paymentForm.addEventListener('submit', function (e) {
                ...
                if (!card) {
                  // Axios Call
                  (0,_postOrder__WEBPACK_IMPORTED_MODULE_2__.postOrder)(formObject);
                  return;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_burger_app"] = self["webpackChunkrealtime_burger_app"] || [];
